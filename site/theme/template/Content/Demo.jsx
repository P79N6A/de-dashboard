...
import { Icon, Tooltip } from 'de-dashboard';
...
export default class Demo extends React.Component {
  ...
  render() {
    ...
    const prefillStyle = `@import 'de-dashboard/dist/de-dashboard.css';\n\n${style || ''}`.replace(
...
<script>
  var mountNode = document.getElementById('container');
    ...
    const codepenPrefillConfig = {
      ...
      css: prefillStyle,
      editors: '001',
      css_external: 'https://unpkg.com/de-dashboard/dist/de-dashboard.css',
      js_external: [
        'react@16.x/umd/react.development.js',
        'react-dom@16.x/umd/react-dom.development.js',
        'moment/min/moment-with-locales.js',
        'de-dashboard/dist/antd-with-locales.js',
...
import React from 'react';
import ReactDOM from 'react-dom';
import 'de-dashboard/dist/de-dashboard.css';
import './index.css';
