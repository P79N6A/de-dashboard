...
```diff
- import { DatePicker, message } from 'de-dashboard';
+ import { DatePicker, message, Alert } from 'de-dashboard';
```
...
If you see logs like in the screenshot below, you might be importing all components by writing `import { Button } from 'de-dashboard';`. This will affect your app's network performance.
